...
| **Marlinks CPA Spatial Concentration** (Gini = 0.8739, PAR = 18.17) | `src/subsea/real_evaluation.py` | `data/marlinks_demo/reduced_dataset_sensor_range_1440_1690.h5` | `artifacts/real_data_evaluation/marlinks_manifest.json` | YES |
| **Marlinks Transit Range Tracking** ($\rho = -0.9482, p = 1.42\times10^{-30}$) | `src/subsea/real_evaluation.py` | `data/marlinks_demo/reduced_dataset_sensor_range_1440_1690.h5` | `artifacts/real_data_evaluation/marlinks_manifest.json` | YES |
